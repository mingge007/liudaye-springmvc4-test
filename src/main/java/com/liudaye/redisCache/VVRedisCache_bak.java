...
public class VVRedisCache_bak extends AbstractValueAdaptingCache {
    private static Logger _log = LoggerFactory.getLogger(VVRedisCache_bak.class);
    @SuppressWarnings("rawtypes")
    private final RedisOperations redisOperations;
    private final RedisOperations redisSlaveOperations;
    private final VVRedisCache_bak.VVRedisCacheMetadata cacheMetadata;
    private final VVRedisCache_bak.CacheValueAccessor cacheValueAccessor;

    /**
     * Constructs a new {@link VVRedisCache_bak} instance.
     *
     ...
     * @param expiration
     */
    public VVRedisCache_bak(String name, byte[] prefix, RedisOperations<? extends Object, ? extends Object> redisOperations,
                            long expiration) {
        this(name, prefix, redisOperations, null, expiration, false);
    }
     ...
     * @since 1.8
     */
    public VVRedisCache_bak(String name, byte[] prefix, RedisOperations<? extends Object, ? extends Object> redisOperations, RedisOperations<? extends Object, ? extends Object> redisSlaveOperations,
        ...
        this.cacheMetadata = new VVRedisCache_bak.VVRedisCacheMetadata(name, prefix);
        this.cacheMetadata.setDefaultExpiration(expiration);
        this.redisOperations = redisOperations;
        this.redisSlaveOperations = redisSlaveOperations;
        this.cacheValueAccessor = new VVRedisCache_bak.CacheValueAccessor(serializer);
    ...
    public <T> T get(final Object key, final Callable<T> valueLoader) {
        ...
        RedisCacheElement cacheElement = new RedisCacheElement(getRedisCacheKey(key),
                new VVRedisCache_bak.StoreTranslatingCallable(valueLoader)).expireAfter(cacheMetadata.getDefaultExpiration());
        VVRedisCache_bak.BinaryRedisCacheElement rce = new VVRedisCache_bak.BinaryRedisCacheElement(cacheElement, cacheValueAccessor);
        ...
        VVRedisCache_bak.RedisWriteThroughCallback callback = new VVRedisCache_bak.RedisWriteThroughCallback(rce, cacheMetadata);

        try {
            byte[] result = (byte[]) getRedisSlaveOperations().execute(callback);
            return (T) (result == null ? null : fromStoreValue(cacheValueAccessor.deserializeIfNecessary(result)));
        } catch (RuntimeException e) {
            throw VVRedisCache_bak.CacheValueRetrievalExceptionFactory.INSTANCE.create(key, valueLoader, e);
        }
    }
    ...
    public RedisCacheElement get(final RedisCacheKey cacheKey) {
        ...
        Boolean exists = (Boolean) getRedisSlaveOperations().execute(new RedisCallback<Boolean>() {
    ...
    public void put(RedisCacheElement element) {
        ...
        redisOperations
                .execute(new VVRedisCache_bak.VVRedisCachePutCallback(new VVRedisCache_bak.BinaryRedisCacheElement(element, cacheValueAccessor), cacheMetadata));
    }
    ...
    public ValueWrapper putIfAbsent(RedisCacheElement element) {
        ...
        new VVRedisCache_bak.VVRedisCachePutIfAbsentCallback(new VVRedisCache_bak.BinaryRedisCacheElement(element, cacheValueAccessor), cacheMetadata);
    ...
    public void evict(final RedisCacheElement element) {
        ...
        Assert.notNull(element, "Element must not be null!");
        redisOperations
                .execute(new VVRedisCache_bak.VVRedisCacheEvictCallback(new VVRedisCache_bak.BinaryRedisCacheElement(element, cacheValueAccessor), cacheMetadata));
    }
     ...
     */
    public void clear() {
        redisOperations.execute(cacheMetadata.usesKeyPrefix() ? new VVRedisCache_bak.VVRedisCacheCleanByPrefixCallback(cacheMetadata)
                : new VVRedisCache_bak.VVRedisCacheCleanByKeysCallback(cacheMetadata));
    }
    ...
    private byte[] doLookup(Object key) {
        ...
        return (byte[]) redisOperations.execute(new VVRedisCache_bak.AbstractVVRedisCacheCallback<byte[]>(
                new VVRedisCache_bak.BinaryRedisCacheElement(new RedisCacheElement(cacheKey, null), cacheValueAccessor), cacheMetadata) {

            @Override
            public byte[] doInRedis(VVRedisCache_bak.BinaryRedisCacheElement element, RedisConnection connection) throws DataAccessException {
    ...
    /**
     * Metadata required to maintain {@link VVRedisCache_bak}. Keeps track of additional data structures required for processing
     * cache operations.
     *
    ...
    static class VVRedisCacheMetadata {
        ...
        /**
         * @return true if the {@link VVRedisCache_bak} uses a prefix for key ranges.
         */
    ...
    static class BinaryRedisCacheElement extends RedisCacheElement {
        ...
        private VVRedisCache_bak.CacheValueAccessor accessor;

        public BinaryRedisCacheElement(RedisCacheElement element, VVRedisCache_bak.CacheValueAccessor accessor) {
    ...
    static abstract class AbstractVVRedisCacheCallback<T> implements RedisCallback<T> {
        ...
        private final VVRedisCache_bak.BinaryRedisCacheElement element;
        private final VVRedisCache_bak.VVRedisCacheMetadata cacheMetadata;

        public AbstractVVRedisCacheCallback(VVRedisCache_bak.BinaryRedisCacheElement element, VVRedisCache_bak.VVRedisCacheMetadata metadata) {
            this.element = element;
        ...
        public abstract T doInRedis(VVRedisCache_bak.BinaryRedisCacheElement element, RedisConnection connection) throws DataAccessException;
    ...
    static abstract class LockingVVRedisCacheCallback<T> implements RedisCallback<T> {
        ...
        private final VVRedisCache_bak.VVRedisCacheMetadata metadata;

        public LockingVVRedisCacheCallback(VVRedisCache_bak.VVRedisCacheMetadata metadata) {
     ...
     * @since 1.5
     */
    static class VVRedisCacheCleanByKeysCallback extends VVRedisCache_bak.LockingVVRedisCacheCallback<Void> {

        private static final int PAGE_SIZE = 128;
        private final VVRedisCache_bak.VVRedisCacheMetadata metadata;

        VVRedisCacheCleanByKeysCallback(VVRedisCache_bak.VVRedisCacheMetadata metadata) {
            super(metadata);
            this.metadata = metadata;
        }
     ...
     * @since 1.5
     */
    static class VVRedisCacheCleanByPrefixCallback extends VVRedisCache_bak.LockingVVRedisCacheCallback<Void> {
        ...
        public VVRedisCacheCleanByPrefixCallback(VVRedisCache_bak.VVRedisCacheMetadata metadata) {
            super(metadata);
            this.metadata = metadata;
        }
     ...
     * @since 1.5
     */
    static class VVRedisCacheEvictCallback extends VVRedisCache_bak.AbstractVVRedisCacheCallback<Void> {

        public VVRedisCacheEvictCallback(VVRedisCache_bak.BinaryRedisCacheElement element, VVRedisCache_bak.VVRedisCacheMetadata metadata) {
         ...
         */
        @Override
        public Void doInRedis(VVRedisCache_bak.BinaryRedisCacheElement element, RedisConnection connection) throws DataAccessException {
     ...
     * @since 1.5
     */
    static class VVRedisCachePutCallback extends VVRedisCache_bak.AbstractVVRedisCacheCallback<Void> {

        public VVRedisCachePutCallback(VVRedisCache_bak.BinaryRedisCacheElement element, VVRedisCache_bak.VVRedisCacheMetadata metadata) {
     ...
     * @since 1.5
     */
    static class VVRedisCachePutIfAbsentCallback extends VVRedisCache_bak.AbstractVVRedisCacheCallback<byte[]> {

        public VVRedisCachePutIfAbsentCallback(VVRedisCache_bak.BinaryRedisCacheElement element, VVRedisCache_bak.VVRedisCacheMetadata metadata) {
            super(element, metadata);
        }
     ...
     * @since 1.7
     */
    static class RedisWriteThroughCallback extends VVRedisCache_bak.AbstractVVRedisCacheCallback<byte[]> {

        public RedisWriteThroughCallback(VVRedisCache_bak.BinaryRedisCacheElement element, VVRedisCache_bak.VVRedisCacheMetadata metadata) {
            super(element, metadata);
        }
